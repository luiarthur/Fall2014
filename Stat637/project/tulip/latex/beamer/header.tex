...
% My Beamer Stuff
  ...
  \def\mydarkcolor{\color{pumpkin}} % Figure Color.       CHANGE THIS!
    ...
    \captionsetup{
      labelfont={bf,figcol}%,textfont={green}
    }
  ...
  \setbeamertemplate{footline}{
    \hbox{
      \hspace{-.17cm}
      \begin{beamercolorbox}[ht=1.9mm,dp=8.1mm,leftskip=.3cm,rightskip=.3cm]{footlinecolor}%
        \insertauthor\hfill\insertshorttitle\hfill\insertpagenumber/\inserttotalframenumber
      \end{beamercolorbox}
    }
  }
