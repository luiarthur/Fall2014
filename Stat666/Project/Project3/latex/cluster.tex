...
\noindent More variability in the variables corresponding to the bolded components for each eigenvector are going to best separate texts in each direction of the plane respectively.
\\
\newpage
Note the table below that shows which proportion of the 15 genre's were put into each of the 3 groups. 
...
\noindent Notice that texts for some of the genre's fall predominately into one cluster.  In some sense, our natural clusters have classified some genre's primarily into one cluster, and similar genre's have been grouped together. Cluster 3 seems to be the fiction cluster, while cluster 2 and 3 seem to kind of share the rest. There seems to be more objective non-fiction in cluster 2, and cluster 1 the somewhat subjective non-fiction.
