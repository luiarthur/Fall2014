...
\begin{figure}\begin{center}
  ...
  \vspace{-2mm}
  \includegraphics[scale=.2]{../code/draw.post.out/Y.pdf}
  \vspace{-15mm}
...
\beginmyfig
  \caption{}
  \includegraphics{../code/draw.post.out/trace.pdf}
  %\vspace{-15mm}
\endmyfig 
%\beginmyfig
%  \caption{}
...
$=2.08$ and variance $=.359$.  Figure 4 shows the posterior mean for $\bm Z$.
...
in Figure 5 and Figure 6. Figure 5 shows the matrix in a $10 \times 36$ form;
Figure 6 shows the matrix in $6 \times 6$ form. That is, each row in $\bm A$
were back-transformed into its matrix form.\\

%\begin{figure}\begin{center}.
\beginmyfig
\minipage{.32\textwidth}
  \caption{Posterior Mean for Z}
  \includegraphics{../code/draw.post.out/postZ.pdf}
\endminipage\hfill
\minipage{.32\textwidth}
  \caption{Posterior Mean for A}
...
\begin{figure}\begin{center}
  ...
  %\includegraphics[height=1\textwidth]{../code/draw.post.out/postA66.pdf}
  \includegraphics[height=.8\textwidth]{../code/draw.post.out/postFriends.pdf}
\end{center}\end{figure}
